...
const CorporateMockup = () => {
  return (
    <div className="w-full h-full min-h-[250px] bg-zinc-950 rounded-2xl overflow-hidden relative shadow-[0_20px_40px_rgba(255,122,0,0.06)] border-0 flex items-center justify-center">
      <img
...
export default function Portfolio() {
  ...
  return (
    <section
      id="projects"
      className="py-24 px-6 md:px-12 bg-zinc-950 text-white z-10 relative border-t border-b border-zinc-900"
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-zinc-400 mt-4 max-w-2xl mx-auto text-sm sm:text-base font-semibold leading-relaxed">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                ...
                >
                  ...
                  <span
                    className={`absolute left-0 top-0 bottom-0 w-1 rounded-full transition-all duration-300 ${
                      isSelected
                        ? "bg-[#ff7a00] scale-y-100"
                        : "bg-transparent scale-y-50 group-hover:bg-zinc-800"
                    }`}
                  />
                  ...
                  <div className="pl-6">
                    ...
                    <h3
                      className={`font-black text-lg transition-colors ${
                        isSelected
                          ? "text-white"
                          : "text-zinc-450 group-hover:text-zinc-200"
                      }`}
                    >
                      {proj.title}
                    </h3>
          ...
          <div className="lg:col-span-7 flex flex-col">
            <div className="p-6 sm:p-8 rounded-[36px] bg-zinc-900/40 border border-zinc-900 relative overflow-hidden backdrop-blur-md flex flex-col justify-between shadow-[0_25px_60px_rgba(255,122,0,0.08)] hover:shadow-[0_25px_60px_rgba(255,122,0,0.12)] transition-shadow duration-500">
              ...
              <div className="flex items-center justify-between border-b border-zinc-900/80 pb-4 mb-6">
                ...
                <div className="px-4 py-1.5 rounded-full bg-zinc-950 text-[10px] text-zinc-550 border border-zinc-900/60 font-mono tracking-wide">
              ...
              <div className="mb-8">
                <span className="text-[10px] text-[#ff7a00] font-black tracking-widest uppercase mb-2 block animate-pulse">
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
                  <div className="md:col-span-6">
                    ...
                    <p className="text-zinc-400 text-xs leading-relaxed mb-6 font-semibold">
                    ...
                    <div className="space-y-3">
                      {PROJECTS[selectedProjectIndex].details.map(
                        (detail, idx) => (
                          <div
                            key={idx}
                            className="p-3.5 rounded-2xl bg-zinc-950/80 border border-zinc-900 text-[11px] text-zinc-350 font-semibold shadow-sm"
                          >
                            {detail}
                          </div>
                        ),
              ...
              {/* Footer Specs Row */}
              <div className="flex flex-wrap gap-3 border-t border-zinc-900 pt-6 mt-auto items-center justify-between">
                <div className="flex flex-wrap gap-1.5">
                  {PROJECTS[selectedProjectIndex].features.map((feature) => (
                    <span
                      key={feature}
                      className="px-3 py-1 rounded-full bg-[#ff7a00]/10 text-[#ff7a00] border border-[#ff7a00]/20 text-[9px] font-black uppercase tracking-wider"
                    >
                      {feature}
                    </span>
                  ))}
                ...
                <a
                  href="#contact"
                  className="text-xs text-[#ff7a00] hover:text-[#d4af37] font-black uppercase tracking-wider flex items-center gap-1.5 transition-colors group"
                >
                  View Case Study{" "}
